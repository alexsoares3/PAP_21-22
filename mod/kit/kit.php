...
// Criar query
$sql ="SELECT equipamento.ID,equipamento.MARCA,equipamento.MODELO,equipamento.ANO,categorias.NOME AS catNome FROM equipamento,categorias WHERE equipamento.kit_ID=$id AND equipamento.categorias_ID=categorias.ID ORDER BY equipamento.ID ASC";
$DEBUG .= "Query SQL: $sql\n";
...
<div class="row">
    ...
    <div class="ml-sm-auto">
        <a href="?m=<?= $module ?>&a=addEquipKit&idKit=<?= $id ?>" class="btn btn-primary" title="Novo"><i class="fi fi-plus-a"></i> Adicionar<br> Equipamento</a>
