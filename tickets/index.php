               ...
               <div class="jumbotron">
                  <?php
                     if ($module=='home' && $action=='home'){
                         ?>
                  <h2>Tickets</h2>
                  Selecione um dos blocos para escolher uma sala.
                  <div class="row" width="33%">
                  <!--Botoes Salas-->  
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="?a=create&espacoID=1" class="btn btn-primary btn-block">Armazém</a>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="./blocos/blocoA.php" class="btn btn-primary btn-block">Bloco A</a>
                              </div>
                           </div>
                        </div> 
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="./blocos/blocoB.php" class="btn btn-primary btn-block">Bloco B</a>
                              </div>
                           </div>
                        </div> 
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="./blocos/blocoC.php" class="btn btn-primary btn-block">Bloco C</a>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="./blocos/blocoE.php" class="btn btn-primary btn-block">Bloco E</a>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-2" style="padding:10px;">
                           <div class="card" style="padding:10px;">
                              <div class="card-body">                             
                              <a href="./blocos/blocoF.php" class="btn btn-primary btn-block">Bloco F</a>
                              </div>
                           </div>
                        </div>   
                  </div>
