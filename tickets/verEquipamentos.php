...
<div class="row">
    ...
    <div class="col-sm-auto">
            ...
            <!--<i class="fi fi-angle-up" title="Crescente"></i>
            <i class="fi fi-angle-down" title="Descrescente"></i>-->
            </form>
    </div>
    &nbsp
    &nbsp
    ...
    <div class="col-sm-auto">
            <form action="?m=<?= $module ?>&a=read" role="form" method="post">
            <label for="orderField">Filtrar por Marca:</label>
                <select id="orderField" name="orderField">
                <?php
                    if ($num > 0) {
                        foreach ($list as $reg) {
                ...
                <button type="submit" name="filterMarca" value="marca">Filtrar</i></button>
            </form>
    </div>-->
    &nbsp
    &nbsp
